...
//		TripStop bus = Main.bStops.get(this.busStopDisp_idx).getUpcomingBus(this.upcomingBusDisp_idx, this.cityCentreDisp);
//		if( bus != null ) {
//			try {
//				writeBusLine(bus);
...
//
//
//	private void writeWaitingTime(TripStop bus) {
...
//
//
//	private void writeRealTimeIndicator(TripStop bus) {
//		setColon( bus.isRealtime() );
//	}
//
//
//	private void writeBusLine(TripStop bus) throws Exception {
